...
st.text("The following Biomass Potentials are grouped first by energy potential, and then by sustainable potential. The energy potential informs the comparison between different biomass categories in terms of how they can be used in the Canadian Bioeconomy. The Sustainable Potentials presented can only be compared within their category to ensure a fair comparison because a comparison of different biomass potentials in dry matter tonnes (DMT) is only valid for biomass subcategories of the same broader category to ensure that they are compared alongside biomass with a similar heating value and thus represent a similar quantitiy of final energy produced. The biomass sustainable potentials breakdown aids in gaining a better understanding of the different biomass types that make up the broader categories. The main six Biomass categories in accordance with Canadian literature are Forestry Biomass, Forestry Residue, Purpose Grown Energy Crops, Crop Residue, Livestock Residue and Urban Waste. ")
st.text("The methodology behind the sustainable removal factors is based off of Canadian literature which defines the sustainable removal factors for different biomass types. These values exist as a scale rather than a set number as they vary based on the biomass conditions and the scenarios. The tool is preset with the sustainable removal factors in the middle of the range of values, representing the average situation.")
